...
m = Model.fromFile( ...
    fullfile("model_source", "spbc.model") ...
    , growth=true ...
    , savePreparsed=fullfile("model_source", "spbc_preparsed.model") ...
);
...
m = steady( ...
    ...
    , "exogenize", ["RR", ] ...
    , "endogenize", ["beta0", ] ...
    , "saveAs", fullfile("model_source", "spbc_blazer.md") ...
);
checkSteady(m);
...
table( ...
    ...
    , "writeTable", "steady_tables/steady.xlsx" ...
)
